<%@ Page Title="" Language="C#" MasterPageFile="~/EditSite.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="wxwpdjWeb.Register" %>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Default.aspx">返回登录</asp:HyperLink>
                </td>
                <td></td>
            </tr>
        </table>
