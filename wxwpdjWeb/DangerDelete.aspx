<%@ Page Title="" Language="C#" MasterPageFile="~/EditSite.Master" AutoEventWireup="true" CodeBehind="DangerDelete.aspx.cs" Inherits="wxwpdjWeb.DangerDelete" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form id="form1" runat="server">
        ...
        <table>
            <tr>
                <td><asp:Label ID="Label3" runat="server" Text="物品名称"></asp:Label></td>
            ...
            <tr><td colspan="3"><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="物品名称不能为空" ControlToValidate="tbName" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator></td></tr>
            <tr>
                <td><asp:Label ID="Label5" runat="server" Text="携带者"></asp:Label></td>
                <td><asp:TextBox ID="tbXdzName" runat="server" Enabled="false"></asp:TextBox></td>
                <td><asp:Label ID="Label6" runat="server" Text="*" ForeColor="Red"></asp:Label></td>
            </tr>
            <tr><td colspan="3"><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="携带者不能为空" ControlToValidate="tbXdzName" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator></td></tr>
            <tr>
                <td><asp:Label ID="Label7" runat="server" Text="性别"></asp:Label></td>
                <td>
                    <asp:DropDownList ID="tbXdzSex" runat="server" Enabled="false">
            ...
            <tr>
                ...
                <td><asp:TextBox ID="tbXdzPhone" runat="server" Enabled="false"></asp:TextBox></td>
            ...
            <tr>
                ...
                <td><asp:TextBox ID="tbXdzSfzh" runat="server" Enabled="false"></asp:TextBox></td>
            ...
            <tr>
                ...
                <td><asp:TextBox ID="tbCatagory" runat="server" Enabled="false"></asp:TextBox></td>
            ...
            <tr>
                ...
                <td><asp:TextBox ID="tbRemark" runat="server" Enabled="false"></asp:TextBox></td>
                <td></td>
            </tr>
            <tr>
                <td></td>
